  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      ...
      <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" href="${pageContext.request.contextPath}/ListadoClientes">Informacion Clientes</a>
        </li>
         <li class="nav-item">
          <a class="nav-link" href="${pageContext.request.contextPath}/ListadoEmpleados">Informacion Profesionales</a>
        </li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <li><a class="dropdown-item" href="${pageContext.request.contextPath}/ListaReporteGeneral">Reporte General</a></li>
          </ul>
        </li>
        
        <li class="nav-item">
          <a class="nav-link" href="${pageContext.request.contextPath}/ListarAsesoria">Asesoria Especial</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="${pageContext.request.contextPath}/ListarAccidente">Accidentes</a>
        </li>
      </ul>
    </div>
  </div>
...
<div class="container">
  <div class="row">
	...
	<a class="text-center btn btn-dark btn-lg" href="${pageContext.request.contextPath}/ListadoClientes" role="button">Actividades</a>

    </div>
    <div class="col-sm text-center">
     	<img class="img-thumbnail" src="http://www.haleco.es/wp-content/uploads/2014/07/PAC_STG14_24A-250x250.jpeg" ><br>
		<a class="btn btn-dark btn-lg" href="${pageContext.request.contextPath}/FormularioAccidente.jsp" role="button">Ingresar Accidente</a>
    </div>
    <div class="col-sm text-center">
     	<img class="img-thumbnail" src="http://www.haleco.es/wp-content/uploads/2014/07/PAC_STG10_20A-250x250.jpeg" ><br>
		<a class="btn btn-dark btn-lg" href="${pageContext.request.contextPath}/ListadoPagosClientes" role="button">Pagos</a>
    </div>
  </div>
 </div>
 </br>
