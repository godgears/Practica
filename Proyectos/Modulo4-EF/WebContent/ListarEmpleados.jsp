...
<table class="table">
	...
	<tr>
		<td class="table-light"" scope="row">${empleado.getNombreempleado()}</td>
...
<br/>
<br/>
<a class="btn btn-primary" href="${pageContext.request.contextPath}/AgregarEmpleado">Agregar Empleado</a>
<a class="btn btn-primary" href="${pageContext.request.contextPath}/ListadoEmpleados">Actualizar Listado Empleado</a>
